...
### Créditos
O **CNX Pack** é todo desenvolvido e mantido pelo **CostelaBR** -> https://costelabr.xyz/. Este projeto é **só um instalador não-oficial pra macOS** — todo o firmware pertence ao projeto original.
